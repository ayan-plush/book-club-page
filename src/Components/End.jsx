...
function End() {
  return (
    <div className=" bg-[#47382B] bg-opacity-75 w-full h-[20vh]">
      <div className='flex items-center w-full h-[10vh]'><a href='https://www.instagram.com/sahitya_dtu/?hl=en' className="w-full text-[#9d896c]  text-[2vh] text-right	font-light underline tracking-widest px-[3vh]   "> INSTAGRAM </a></div>
